                            ...
                            <ul>
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid"
                                                            src="{{asset('assets/frontend/img/collection/collection__1.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid"
                                                            src="{{asset('assets/frontend/img/collection/collection__2.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid"
                                                            src="{{asset('assets/frontend/img/collection/collection__3.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid"
                                                            src="{{asset('assets/frontend/img/collection/collection__4.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid"
                                                            src="{{asset('assets/frontend/img/collection/collection__5.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid"
                                                            src="{{asset('assets/frontend/img/collection/collection__6.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid"
                                                            src="{{asset('assets/frontend/img/collection/collection__7.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="mega__menu__li mega__menu__image">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="categories.html">
                                                        <img class="img-fluid"
                                                            src="{{asset('assets/frontend/img/collection/collection__8.png')}}"
                                                            alt="Collection">
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <li><a class="headerarea__has__dropdown" href="#">Pages
                                    ...
                                    <ul class="headerarea__submenu">
                                        ...
                                        <li><a href="https://themeforest.net/user/marino-themes">Purchase
                                                Now</a></li>
                                    </ul>
                                </li>
                            </ul>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-4 col-5">
                <div class="mobile-logo">
                    <a class="logo__mobile" href="#"><img src="{{asset('assets/frontend/img/logo/logo__1.png')}}"
                            alt="logo"></a>
                </div>
            </div>
            <div class="col-sm-4 col-5">
                        ...
                        <ul class="mobile-menu">
                            ...
                            <li class="menu-item-has-children"><a href="blog.html">Pages</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="categories.html">Categories</a></li>
                                    <li><a href="checkout.html">Checkout</a></li>
                                    <li><a href="https://themeforest.net/user/marino-themes">Purchase Now</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
